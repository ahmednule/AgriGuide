  ...
  return (
    <>
      ...
      <p>
        ...
        your crops. Each pest entry includes a clear description of what the
        pest looks like, what crops it targets, and how it behaves. Images will
        also be provided to help you recognize the pest easily. For each pest,
        we provide practical tips on how to manage and control them, including
        both natural and chemical methods. This resource is designed to help you
        keep your crops healthy and thriving by identifying and addressing pest
        problems early.
      </p>
      {
